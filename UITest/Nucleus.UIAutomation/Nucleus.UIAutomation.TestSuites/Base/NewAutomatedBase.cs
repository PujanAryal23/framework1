...
{
    public class NewAutomatedBase : IDisposable
    {
        ...
        protected virtual void ClassInit()
        {
            ...
            switch (UserLoginIndex)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    BasePage = CurrentPage = QuickLaunch = Login.LoginAsHciUserWithMyDashboardAuthorityAndReadOnlyProductDashboardAuthority();
                    break;
                case 99:
