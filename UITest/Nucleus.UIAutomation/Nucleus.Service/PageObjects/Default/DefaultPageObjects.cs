...
namespace Nucleus.Service.PageObjects.Default
{
    public class DefaultPageObjects : PageBase
    {
        ...
        public const string DownloadCIWIconId = "div.ciw_button";
        ...
        public const string WorkingAjaxMessageCssLocator = ":not(.is_hidden)>div.small_loading";
        #endregion
        ...
        [FindsBy(How = How.XPath, Using = QuickLaunchButtonXPath)]
        public ImageButton QuickLaunchButton;

        [FindsBy(How = How.CssSelector, Using = SwitchClientCssSelector)]
        public ImageButton SwitchClientButton;

        [FindsBy(How = How.Id, Using = ClientSmallBrandingImgId)]
        public ImageButton ClientSmallBrandingImage;

        [FindsBy(How = How.XPath, Using = LogOutButtonXPath)]
        public ImageButton LogoutButton;

        [FindsBy(How = How.XPath, Using = HelpCenterXPath)] 
        public ImageButton HelpCenterButton;

        [FindsBy(How = How.Id, Using = DocumentLinkId)]
        public Link DocumentsLink;

        
        [FindsBy(How = How.CssSelector, Using = DownloadCIWIconId)]
        public ImageButton DownloadCIWIcon;
        #endregion
