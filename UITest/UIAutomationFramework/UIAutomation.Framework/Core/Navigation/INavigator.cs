...
namespace UIAutomation.Framework.Core.Navigation
{
    ...
    public interface INavigator : IDisposable
    {
        ...
        /// <returns>The object of the current page. </returns>
        T Navigate<T>(Action action) where T : PageBase, new();
        ...
        /// <returns>The object of the current page.</returns>
        T Navigate<T>(Action action, Func<T> pageBase) where T : PageBase, new();
