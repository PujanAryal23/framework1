...
namespace UIAutomation.Framework.Core.Driver
{
    ...
    public static class SiteDriver
    {
        ...
        /// </summary>
        private static IJavaScriptExecutor _je;
        ...
        private static DriverService _primaryDriverService;
        ...
        public static int SleepInterval { get { return  _browserOptions.SleepInterval; } }

        public static int ElementTimeOut { get { return _browserOptions.ElementLoadTimeout; } }
        ...
        /// Clicks this element
        /// </summary>
        public static void ClickAndHold(string select, How selector)
        {
        ...
        public static string GetElementText(string select, How selector, int timeOut = 0)
        {
            try
            {
        ...
        public static bool IsElementDisplayed(string select, How selector, int timeOut = 0)
        {
            try
            {
        ...
        /// <returns></returns>
        public static bool IsElementPresent(string select, How selector, IElement context)
        {
            try
            {
        ...
        /// Waits until a condition is true or times out.
        /// </summary>
        public static void WaitForJqueryStatusCondition()
        {
            try
            {
                _waitPageLoad.Until(d =>
                {
                    try
                    {
                        return JavaScriptExecutor.ExecuteJqueryStatus();
                    }
                    catch (Exception)
                    {
                        DismissAlert();
        ...
        public static void AcceptAlert(string alertName)
        {
            _webdriver.SwitchTo().Alert().Accept();
        }
        ...
        public static bool SwitchWindowByTitle(string windowTitle)
        {
        ...
        public static bool SwitchDynamicWindowByTitle(string windowTitle)
        {
            foreach (string handle in _webdriver.WindowHandles)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public static IWebElement ReturnActiveElement()
        {
        ...
        public static void SwitchFrameById(string frameName)
        {
        ...
        public static void SwitchFrameByClass(string className)
        {
        ...
        public static void SwitchFrameByCssLocator(string cssLocator)
        {
        ...
        public static void SwitchFrameByJQuery(string cssLocator)
        {
        ...
        public static void MouseOver(string select, How selector, int timeout = 2000,bool release = false)
        {
            var action = new Actions(_webdriver);
            var webElement = FindElement(select, selector, _webdriver);
            if(release)
        ...
        /// <param name="select">The locating element.</param>
        /// <param name="selector">The locating mechanism to use.</param>
        public static void RightClick(string select, How selector)
        {
            var action = new Actions(_webdriver);
        ...
        public static object InitializePageElement(object page)
        {
        ...
        public static void WaitForIe(int millisecondsTimeout)
        {
        ...
        public static void ClickAndWaitMoreOnException(string select, How selector, int waitTime)
        {
            try
            {
        ...
        public static List<string> FindElements(string select, How selector, string selectSelector, bool isNull = false)
        {
            ...
            if (isNull)
                return FindElements(select, selector, _webdriver).Select(element => element.Text).ToList();
        ...
        public static void FindElementAndChecked(string select, How selector)
        {
        ...
        public static void FindElementAndSetText(string select, How selector, string reasonCode)
        {
        ...
        public static string FindElementAndGetAttribute(string select, How selector, int index)
        {
            return FindElements(select, selector, _webdriver).ToList()[index].GetAttribute("id");
        }

        public static string FindElementAndGetAttribute(String select, How selector, string attribute = "id")
        {
            return FindElements(select, selector, _webdriver).Last().GetAttribute(attribute);
        }
        
        public static List<string> FindElementAndGetNotNullIdAttribute(string select, How selector)
        {
            return FindElements(select, selector, _webdriver).Select(x => x.GetAttribute("id")).Where(
                x => x != string.Empty).ToList();
        }

        public static List<bool> FindElementAndGetCondition(string select, How selector)
        {
        ...
        public static bool FindElementAndCheckCondition(string select, How selector, out int index)
        {
            index = 0;
        ...
        public static List<string> FindElementAndGetIdAttribute(string select, How selector)
        {
            return FindElements(select, selector, _webdriver).Select(x => x.GetAttribute("id")).ToList();
        }
        public static List<string> FindElementAndGetAttributeByAttributeName(string select, How selector, string attributeName)
        {
        ...
        public static List<string> FindElementAndGetClassAttribute(string select, How selector)
        {
            return FindElements(select, selector, _webdriver).Select(x => x.GetAttribute("class")).ToList();
        }


        public static List<bool> FindElementAndGetCheckedAttribute(string select, How selector)
        {
        ...
        public static List<bool> FindElementAndGetActiveAttribute(string select, How selector)
        {
            List<bool> result = new List<bool>();
            foreach (var check in FindElements(select, selector, _webdriver).Where(x => x.Enabled))
            {
        ...
        public static List<bool> FindElementsAndGetAttributeByClass(string className, string select, How selector)
        {
            List<bool> result = new List<bool>();
        ...
        public static List<bool> FindElementsAndGetAttributeByTwoClass(string className1,string className2, string select, How selector)
        {
            List<bool> result = new List<bool>();
            foreach (var element in FindElements(select, selector, _webdriver))
            {
        ...
        public static List<string> FindElementsAndGetAttribute(string attribute, string select, How selector)
        {
        ...
        public static void FindElementAndClickOnCheckBox(string select, How selector)  //for checbox
        {
        ...
        /// <param name="url"></param>
        /// <returns></returns>
        private static HttpStatusCode GetHttpStatusCode(string url)
        {
        ...
        private static IWebDriver LaunchFirefox()
        {
            ...
            {
                _driverService = FirefoxDriverService.CreateDefaultService(Path.GetFullPath(PATH));
        ...
        /// </summary>
        /// <returns>A <see cref="IWebDriver"/></returns>
        private static IWebDriver LaunchInternetExplorer()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="IWebDriver"/></returns>
        private static IWebDriver LaunchChrome(string incognito = "0")
        {
        ...
        /// <returns>The first matching <see cref="IWebElement"/> on the current context.</returns>
        /// <exception cref="NoSuchElementException">If no element matches the criteria.</exception>
        public static IWebElement FindElement(string select, How selector)
        {
        ...
        public static double ReturnPageLoadTime()
        {
        ...
        public static Dictionary<string, object> WebTimings(string pagename, int runNo)
        {
        ...
        /// Clicks this element
        /// </summary>
        public static void ClickLinkInNewTab(string select, How selector)
        {
        ...
        public static bool IsElementEnabled(string select, How selector, int timeOut = 0)
        {
            try
            {
        ...
        public static Point GetElementIndex(string select, How selector)
        {
             return FindElement(select, selector, _webdriver, 0).Location;
        }

        public static IEnumerable<IWebElement> GetWebElementList(string select, How selector)
        {
            return FindElements(select, selector, _webdriver);
        }
